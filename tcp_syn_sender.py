...
dest_ip=ip2hex(Lines[0])#destination ip
...
#checksum_tcp=" ".join(checksum_tcp[i:i+2] for i in range (0,len(checksum_tcp),2))
#proto4,"00","14",src_port,dest_port,seq_num,ack,h_len,w_size,"00 00",up
